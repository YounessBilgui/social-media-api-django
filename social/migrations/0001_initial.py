...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddIndex(
            model_name="post",
            index=models.Index(fields=["-created_at"], name="social_post_created_87cf3d_idx"),
        ),
        migrations.AddIndex(
            model_name="like",
            index=models.Index(fields=["user", "post"], name="social_like_user_id_8680df_idx"),
        ),
        migrations.AddIndex(
            model_name="follow",
            index=models.Index(fields=["follower", "following"], name="social_follo_follower_9cf9c1_idx"),
        ),
